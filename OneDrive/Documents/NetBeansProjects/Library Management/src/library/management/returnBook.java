...
public class returnBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(241, 180, 0));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/library/management/return book png.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/library/management/red-x-mark-transparent-background-3.png"))); // NOI18N
    ...
    try {
        ...
        if (rs.next()) {
            // Assuming the return date is in the third column and some other info in the fourth
            jTextField3.setText(rs.getString(3)); // Return date
            jTextField4.setText(rs.getString(4)); // Some other relevant info
